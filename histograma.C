...
//=========  (Thu Jun 22 16:48:12 2023) by ROOT version 6.26/10
   ...
   TH1D *miHistograma__1 = new TH1D("miHistograma__1","Ejercicio-2-Gaussiana",64,-5,5);
   ...
   TPaveText *pt = new TPaveText(0.3096839,0.9339831,0.6903161,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Ejercicio-2-Gaussiana");
   pt->Draw();
   c1_n2->Modified();
   c1_n2->cd();
